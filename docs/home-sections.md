...
Edit `src/pages/home/homeSections.ts` to change the images, labels, descriptions, routes, and accent colours. The four image imports at the top are the only paths you need to replace when changing photos.
